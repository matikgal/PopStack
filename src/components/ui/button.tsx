  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        brutal: "bg-primary text-primary-foreground border-2 border-foreground brutal-shadow hover:translate-x-1 hover:translate-y-1 transition-transform font-bold uppercase tracking-wide",
        glass: "glass-panel backdrop-blur-xl border border-border/50 hover:bg-card/90 text-foreground",
        gradient: "gradient-primary text-white border-0 hover:opacity-90 font-bold",
      },
      size: {
